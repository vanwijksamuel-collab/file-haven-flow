  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-background/50 backdrop-blur-sm hover:bg-accent hover:text-accent-foreground hover:shadow-md hover:-translate-y-0.5",
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:shadow-xl hover:shadow-primary/25 hover:-translate-y-1 hover:scale-105 active:scale-100 active:translate-y-0",
        glass: "glass text-foreground hover:shadow-lg hover:-translate-y-0.5 backdrop-blur-md",
        premium: "bg-gradient-to-r from-primary via-accent to-primary-glow text-primary-foreground hover:shadow-xl hover:shadow-primary-glow/30 hover:-translate-y-1 animate-gradient-x",
      },
      size: {
